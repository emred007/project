...
const MESSAGE_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/database error saving new user/i, 'Veritabanı hatası: Supabase\'de TAM_KURULUM.sql dosyasını çalıştırın veya FIX_KAYIT_TRIGGER.sql dosyasını uygulayın.'],
  [/already been registered/i, 'Bu e-posta adresi zaten kayıtlı. Giriş yapmayı deneyin.'],
  [/duplicate key.*username/i, 'Bu kullanıcı adı zaten alınmış. Farklı bir kullanıcı adı deneyin.'],
]
