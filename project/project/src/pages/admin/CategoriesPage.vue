...
function openCreate() { editingCategory.value = null; form.value = { name: '', description: '', parent_id: '', is_active: true }; showForm.value = true }
function openEdit(category: Category) { editingCategory.value = category; form.value = { name: category.name, description: category.description || '', parent_id: category.parent_id || '', is_active: category.is_active }; showForm.value = true }
