...
export const XIAOMI_NOTE_13_PRO_IMAGE =
  'https://images.unsplash.com/photo-1598327105666-5b86a8e9a267?auto=format&fit=crop&w=600&q=80'

const BROKEN_IMAGE_SNIPPETS = ['1092678', '163100']
...
export function enrichProductImages(product: Product): Product {
  ...
  if (!isBroken) return product
  if (demo?.images?.[0]) return { ...product, images: demo.images }
...
export const DEMO_PRODUCTS: Product[] = [
  ...
  product({
    ...
    images: ['https://images.pexels.com/photos/159711/books-book-pages-read-literature-159711.jpeg?auto=compress&cs=tinysrgb&w=600'],
