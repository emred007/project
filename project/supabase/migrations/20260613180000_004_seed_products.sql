...
BEGIN
  ...
  ('44444444-4444-4444-4444-444444444006', 'Xiaomi Redmi Note 13 Pro', 'xiaomi-redmi-note-13-pro', '200MP kamera, AMOLED ekran.', 14999, 12999, 95, 'XM-RN13P', 'Xiaomi', '11111111-1111-1111-1111-111111111001', seller_uuid, ARRAY['https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=600&q=80'], 'approved', 4.4, 445, true, true, true),
